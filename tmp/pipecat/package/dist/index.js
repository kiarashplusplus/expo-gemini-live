...
const $b1a2fe36be912934$export$7bdaf0e0d661a8f5 = "1.0.0";
...
async function $e93e1075413e9e2e$export$699251e5611cc6db(cxnOpts, abortController) {
    ...
    return new Promise((resolve, reject)=>{
        (async ()=>{
            ...
            (0, $42491a06a064f4c0$export$af88d00dbe7f521).debug(`[Pipecat Client] Fetching from ${cxnOpts.endpoint}`);
            fetch(cxnOpts.endpoint, {
                ...
                (0, $42491a06a064f4c0$export$af88d00dbe7f521).debug(`[Pipecat Client] Received response from ${cxnOpts.endpoint}`, res);
...
class $02f900e1428a591c$export$8f7f86a77535f7a3 extends $02f900e1428a591c$var$RTVIEventEmitter {
        ...
        const wrappedCallbacks = {
            ...
            onError: (message)=>{
                ...
                // eslint-disable-next-line @typescript-eslint/no-unused-vars
                    ...
                    (0, $42491a06a064f4c0$export$af88d00dbe7f521).debug("Could not emit error", message);
                }
     ...
     */ _initialize() {
        ...
        this._messageDispatcher = new (0, $3b981481778defd6$export$e9a960646cc432aa)(this._transport.sendMessage.bind(this._transport));
    }
    /**
     ...
     */ sendClientMessage(msgType, data) {
        this._transport.sendMessage(new (0, $b1a2fe36be912934$export$69aa9ab0334b212)((0, $b1a2fe36be912934$export$38b3db05cbf0e240).CLIENT_MESSAGE, {
            t: msgType,
            d: data
        }));
    }
    ...
    async appendToContext(context) {
        ...
        await this._transport.sendMessage(new (0, $b1a2fe36be912934$export$69aa9ab0334b212)((0, $b1a2fe36be912934$export$38b3db05cbf0e240).APPEND_TO_CONTEXT, {
            role: context.role,
    ...
    async sendText(content, options = {}) {
        await this._transport.sendMessage(new (0, $b1a2fe36be912934$export$69aa9ab0334b212)((0, $b1a2fe36be912934$export$38b3db05cbf0e240).SEND_TEXT, {
            content: content,
            options: options
        }));
    }
     ...
     */ disconnectBot() {
        this._transport.sendMessage(new (0, $b1a2fe36be912934$export$69aa9ab0334b212)((0, $b1a2fe36be912934$export$38b3db05cbf0e240).DISCONNECT_BOT, {}));
    }
    handleMessage(ev) {
            ...
            case (0, $b1a2fe36be912934$export$38b3db05cbf0e240).BOT_READY:
                {
                    ...
                    if (botVersion[0] < 1) (0, $42491a06a064f4c0$export$af88d00dbe7f521).warn("[Pipecat Client] Bot version is less than 1.0.0, which may not be compatible with this client.");
            ...
            case (0, $b1a2fe36be912934$export$38b3db05cbf0e240).LLM_FUNCTION_CALL:
                {
                     ...
                     */ fc(params).then((result)=>{
                            ...
                            this._transport.sendMessage(new (0, $b1a2fe36be912934$export$69aa9ab0334b212)((0, $b1a2fe36be912934$export$38b3db05cbf0e240).LLM_FUNCTION_CALL_RESULT, {
